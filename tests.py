...
# Ask-the-screen tests. The feature is fast-only; on classic these
# tests exist identically and skip themselves, so the file stays one
# file on both branches (versions.py's rule for shared files).
try:
