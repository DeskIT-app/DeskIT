...
CONFIG_VERSION: int = 5       # 2: the sync follows the account; 3: the history sync
                              #    follows the settings sync; 4: the lock's cards ask
                              #    nothing new; 5: nor do the account card's honest
                              #    words (migrations.py)
