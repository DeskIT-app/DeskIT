...
כרטיס אחד: בשביל מה החשבון (המילים שלמדת וההגדרות הולכות איתך לכל מחשב שתתחבר בו), מה
נשמר (המזהה והאימייל של חשבון גוגל שתבחר) ומה לעולם לא (הקול שלך, מה שאמרת, המפתחות שלך).
**Sign in with Google** פותח את הדפדפן פעם אחת; המחשב הזה זוכר אותך עד שתתנתק. אין דרך
לעבור את העמוד הזה בלי חשבון.

**כבר התחברת פעם, במחשב אחר?** דסק-איט מזהה שבחשבון שלך כבר יש הגדרות: הכרטיס אומר
*ברוך שובך*, הכפתור אומר **Open DeskIT**, ולחיצה עליו מורידה את המילים שלמדת ואת ההגדרות
ופותחת את דסק-איט — בלי עמודי המיקרופון, המשפט, המקשים והתוספות; רק עמוד ההורדות, אם למחשב
הזה עדיין חסר משהו. המיקרופון והמקשים הם הרגילים עד שתשנה אותם ב־Settings. מפתח ה־Groq שלך
לעולם לא בחשבון: מדביקים אותו פעם אחת במחשב החדש (Settings ‹ Privacy).
