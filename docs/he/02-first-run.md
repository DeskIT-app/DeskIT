...
שהקלדת), ושרק הקול שלך לא יוצא מהמחשב הזה לעולם: המילים שלמד וההגדרות נשמרים בחשבון שלך,
וגם מה שאמרת ומפתחות הענן שלך — נעולים במפתח שרק המחשבים שלך מחזיקים (העמוד האחרון מכבה
את זה). **Continue with Google** פותח את
...
במחשב האחר, וזה הכול: המילים שלמדת, ההגדרות ומה שאמרת יורדים ודסק-איט נפתח מעצמו — בלי עמודי
המיקרופון, המשפט, המקשים והתוספות; רק עמוד ההורדות, אם למחשב הזה עדיין חסר משהו. המיקרופון
והמקשים הם הרגילים עד שתשנה אותם ב־Settings. מה שאמרת ומפתחות הענן נעולים במפתח שרק
המחשבים שלך מחזיקים, ולכן עוד צעד אחד: העמוד מציג קוד של שמונה תווים ומחכה; פותחים את
השולחן במחשב האחר — מסך הבית שם מציג את אותו קוד — ולוחצים **Approve**. כל מה שנעול מגיע
אז גם לכאן. אין מחשב אחר ליד? מקלידים את מפתח השחזור שדסק-איט יצר לך (Settings ‹ Privacy ‹
The lock, בכל מחשב שכבר בפנים). או **Later**: בינתיים דסק-איט עובד עם המילים וההגדרות,
וכרטיס החשבון בשולחן שומר את הקוד.
...
- **Keep my words, settings and what I said in my account** — דלוק. המילים שדסק-איט למד
