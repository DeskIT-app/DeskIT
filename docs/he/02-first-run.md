...
- **Keep my words, settings and what I said in my account** — דלוק. המילים שדסק-איט למד
  ממך, ההגדרות ששינית והטקסט של מה שאמרת הולכים איתך לכל מחשב שתיכנס אליו עם החשבון, כך
  שהוא שומע אותך בדרך שלך כבר מהמשפט הראשון ועמוד Said הוא אותו עמוד גם שם. אף פעם לא
  הקול או המפתחות. לכבות אחר כך: Settings > Privacy > **Withdraw** בשורה *Syncing settings
