...
**חדש בדסק-איט?** — **Create an account**. שדה לשם שלך (כך דסק-איט קורא לך; אפשר להשאיר
ריק), בשביל מה החשבון (המילים שלמדת וההגדרות הולכות איתך לכל מחשב שתתחבר בו), מה נשמר
(המזהה והאימייל של חשבון גוגל שתבחר, השם שהקלדת) ומה לעולם לא (הקול שלך, מה שאמרת,
המפתחות שלך). **Continue with Google** פותח את הדפדפן פעם אחת; המחשב הזה זוכר אותך עד
שתתנתק, ושאר ההתקנה ממשיכה.
...
בחרת בכרטיס הלא נכון? קישור מתחת לכל אחד מוביל לשני. יצרת חשבון עם חשבון גוגל שכבר יש בו
הגדרות של דסק-איט? העמוד אומר *ברוך שובך* והכפתור אומר **Open DeskIT**. התחברת עם חשבון
שעדיין אין בו כלום? העמוד אומר זאת, ו־**Continue** מריץ את ההתקנה הרגילה.
