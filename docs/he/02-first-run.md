...
כרטיסים ליד הנקודה — זה המדריך; הדף הזה הוא הגרסה הארוכה שלו.
...
| מתג | מה הוא עושה |
|---|---|
| Fix misheard words with a free cloud model (text only) | כבוי. הדלקה פותחת קודם את כרטיס ההסכמה ([פרק 5](05-cloud)); צריך מפתח Groq חינמי משלך. |
...
המקש שמחזיקים, ועוד שני מתגים שנשאלים פעם אחת: **Start with Windows** (רשומת הפעלה
למשתמש שלך) ו־**Dictate from your phone** ([פרק 6](06-phone)). **Open the desk** פותח את
לוח המחוונים; **Finish** פשוט מסיים. אם דילגת על המודל, הדף אומר זאת ול־Home יש את כפתור
ההורדה.
