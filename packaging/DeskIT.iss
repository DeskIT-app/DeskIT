...
AppPublisherURL=https://github.com/massifapp/DeskIT
AppSupportURL=https://github.com/massifapp/DeskIT
AppUpdatesURL=https://github.com/massifapp/DeskIT/releases
