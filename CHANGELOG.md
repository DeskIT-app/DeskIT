...
לחיצה כפולה אחת פותחת את דסק-איט: הקיצור מעלה את השולחן והאפליקציה עולה מאחוריו — עד עכשיו הלחיצה הראשונה הדליקה את הנקודה ורק השנייה הראתה את השולחן; ההפעלה עם ווינדוס עדיין לא פותחת חלון. מודל הדיבור עולה יחד עם האפליקציה, איך שלא הופעלה — גם מהשולחן, שעד עכשיו הפעיל אותה בלי המודל וחיכה ל-Start; Settings > The app > "Load the speech model when DeskIT starts" מכבה את זה. התחברות של מי שכבר יש לו חשבון מורידה את המילים שלמדת לפני שהשולחן נפתח (המשיכה של האשף דילגה עליהן, והן הגיעו רק עם הסנכרון הראשון של האפליקציה חצי דקה אחר כך).
