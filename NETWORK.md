...
Not yet in the list, refused until then: the Supabase project of the
optional account (`<ref>.supabase.co`) — set as one value in `net.py`
when that phase ships, never as a suffix rule.
